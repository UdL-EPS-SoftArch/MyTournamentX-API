Feature: Edit Tournament
  ...
  Scenario: Edit tournament level as Tournament Master
    Given I login as "demoTM" with password "password"
    And I register a new tournament with name "FirstTournament",level "AMATEUR" and game "LoL"
    When I edit tournament with name "FirstTournament" and new level "BEGINNER"
    Then The response code is 200
    And It has been edited a tournament with name "FirstTournament",level "BEGINNER" and game "LoL"
